...
The advantage to implicit testing is that lineups do not require a specification of a feature to of interest in the testing framework, i.e.\  we do not have to ask questions such as ``which group has a higher proportion of responses".
