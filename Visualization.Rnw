...
% Page header
\markboth{Author et al.}{Testing Statistical Graphics}

% Title
\title{Testing Statistical Graphics: What makes a good chart?}


%Authors, affiliations address.
% No idea how this should be ordered, so just doing it alphabetically for now :)
\author{Dianne Cook,$^1$ Heike Hofmann,$^2$ and Susan Vanderplas$^2$}
...
Historically, the development of graphs and charts has been linked to the development of coordinate systems \citep{fienbergGraphicalMethodsStatistics1979,benigerQuantitativeGraphicsStatistics1978,funkhouserHistoricalDevelopmentGraphical1937} and abstract representations of data. Preceding the development of formal mathematical coordinates, however, humanity has been representing spatial information using maps\citep{smithImagoMundiLogo1996} with varying degrees of abstraction. \svp{there has to be a better transition here, but I've spent too much time on it to bother right now} The polymaths who developed the foundations of current scientific pursuits spent considerable time collecting demographic and economic data as well as observations about the natural world; as a result, they began to experiment with methods for exploring that data visually. During the 18th and 19th centuries, governments became involved, assembling data and graphical representations into the statistical atlases created by A. F. W. Crome\citep{roystonStudiesHistoryProbability1956}, William Playfair\citep{playfair1801statistical}, Francis Walker\citep{atlas}, and contemporaries. As new charts were invented to represent data differently and highlight features of data, discussions about the use of statistical graphics began to appear in the literature\citep{wickham2013graphical,brinton1917graphic,karsten1923charts}\svp{I'd prefer to cite the originals here, but I went looking and did not find anything all that promising. Granted, I don't read French, but I found the book online (https://gallica.bnf.fr/ark:/12148/btv1b86266127/f98.item) and can't find any reference to statistics or charts on the pages around i86/186/86}, including the relative strengths and weaknesses of various types of charts. In most cases, the drive to produce a classification system for charts and graphs or a system of recommendations for presenting charts and graphs were heuristic based, rather than based on experimentation. 
