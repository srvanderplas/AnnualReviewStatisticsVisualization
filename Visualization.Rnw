...
Many studies use a combination of the explicitly structured graphical tests discussed here. Talk-aloud studies are relatively easy to integrate with eye tracking studies, and it is not difficult to add in direct observations or psychophysical evaluation methods as part of the trial design. 

- zgraggenInvestigatingEffectMultiple2018 - talk aloud, eye tracking, and asking participants questions, combined with interactive graphics and randomly generated datasets (not quite lineups, but close). 
