...
There is huge abundance of applications and graphics calling itself \textit {interactive} - yet then \citep{debby} and now there is not much agreement over what `interactive graphics' actually means. 
