...
\begin{itemize}
\item \citet{dunbar1995scientists} - not charts, but scientific reasoning using talk-aloud
\item \citet{trickettDipsyDoodlesStreamingMotions2000} and \citet{trickett2000blobs} - exploratory data analysis using talk-aloud protocol
\item \citet{gregorytraftonTurningPicturesNumbers2000} for complex, domain-specific visualizations and interactivity
\end{itemize}
